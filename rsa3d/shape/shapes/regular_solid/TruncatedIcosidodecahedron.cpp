...
void TruncatedIcosidodecahedron::calculateStatic(const std::string &attr) {
    ...
    RegularSolid<TruncatedIcosidodecahedron>::orientedVertices =
            {Vector<3>{{gi, gi, gp3}}, Vector<3>{{gi, gi, -gp3}}, Vector<3>{{gi, -gi, gp3}}, Vector<3>{{-gi, gi, gp3}},
             Vector<3>{{-gi, -gi, gp3}}, Vector<3>{{-gi, gi, -gp3}}, Vector<3>{{gi, -gi, -gp3}}, Vector<3>{{-gi, -gi, -gp3}},
             Vector<3>{{gi, gp3, gi}}, Vector<3>{{gi, gp3, -gi}}, Vector<3>{{gi, -gp3, gi}}, Vector<3>{{-gi, gp3, gi}},
             Vector<3>{{-gi, -gp3, gi}}, Vector<3>{{-gi, gp3, -gi}}, Vector<3>{{gi, -gp3, -gi}}, Vector<3>{{-gi, -gp3, -gi}},
             Vector<3>{{gp3, gi, gi}}, Vector<3>{{gp3, gi, -gi}}, Vector<3>{{gp3, -gi, gi}}, Vector<3>{{-gp3, gi, gi}},
             Vector<3>{{-gp3, -gi, gi}}, Vector<3>{{-gp3, gi, -gi}}, Vector<3>{{gp3, -gi, -gi}}, Vector<3>{{-gp3, -gi, -gi}},

             Vector<3>{{git2, g, gt2p1}}, Vector<3>{{git2, g, -gt2p1}}, Vector<3>{{git2, -g, gt2p1}}, Vector<3>{{-git2, g, gt2p1}},
             Vector<3>{{-git2, -g, gt2p1}}, Vector<3>{{-git2, g, -gt2p1}}, Vector<3>{{git2, -g, -gt2p1}}, Vector<3>{{-git2, -g, -gt2p1}},
             Vector<3>{{g, gt2p1, git2}}, Vector<3>{{g, gt2p1, -git2}}, Vector<3>{{g, -gt2p1, git2}}, Vector<3>{{-g, gt2p1, git2}},
             Vector<3>{{-g, -gt2p1, git2}}, Vector<3>{{-g, gt2p1, -git2}}, Vector<3>{{g, -gt2p1, -git2}}, Vector<3>{{-g, -gt2p1, -git2}},
             Vector<3>{{gt2p1, git2, g}}, Vector<3>{{gt2p1, git2, -g}}, Vector<3>{{gt2p1, -git2, g}}, Vector<3>{{-gt2p1, git2, g}},
             Vector<3>{{-gt2p1, -git2, g}}, Vector<3>{{-gt2p1, git2, -g}}, Vector<3>{{gt2p1, -git2, -g}}, Vector<3>{{-gt2p1, -git2, -g}},

             Vector<3>{{gi, g2, gt3m1}}, Vector<3>{{gi, g2, -gt3m1}}, Vector<3>{{gi, -g2, gt3m1}}, Vector<3>{{-gi, g2, gt3m1}},
             Vector<3>{{-gi, -g2, gt3m1}}, Vector<3>{{-gi, g2, -gt3m1}}, Vector<3>{{gi, -g2, -gt3m1}}, Vector<3>{{-gi, -g2, -gt3m1}},
             Vector<3>{{g2, gt3m1, gi}}, Vector<3>{{g2, gt3m1, -gi}}, Vector<3>{{g2, -gt3m1, gi}}, Vector<3>{{-g2, gt3m1, gi}},
             Vector<3>{{-g2, -gt3m1, gi}}, Vector<3>{{-g2, gt3m1, -gi}}, Vector<3>{{g2, -gt3m1, -gi}}, Vector<3>{{-g2, -gt3m1, -gi}},
             Vector<3>{{gt3m1, gi, g2}}, Vector<3>{{gt3m1, gi, -g2}}, Vector<3>{{gt3m1, -gi, g2}}, Vector<3>{{-gt3m1, gi, g2}},
             Vector<3>{{-gt3m1, -gi, g2}}, Vector<3>{{-gt3m1, gi, -g2}}, Vector<3>{{gt3m1, -gi, -g2}}, Vector<3>{{-gt3m1, -gi, -g2}},

             Vector<3>{{gt2m1, 2, gp2}}, Vector<3>{{gt2m1, 2, -gp2}}, Vector<3>{{gt2m1, -2, gp2}}, Vector<3>{{-gt2m1, 2, gp2}},
             Vector<3>{{-gt2m1, -2, gp2}}, Vector<3>{{-gt2m1, 2, -gp2}}, Vector<3>{{gt2m1, -2, -gp2}}, Vector<3>{{-gt2m1, -2, -gp2}},
             Vector<3>{{2, gp2, gt2m1}}, Vector<3>{{2, gp2, -gt2m1}}, Vector<3>{{2, -gp2, gt2m1}}, Vector<3>{{-2, gp2, gt2m1}},
             Vector<3>{{-2, -gp2, gt2m1}}, Vector<3>{{-2, gp2, -gt2m1}}, Vector<3>{{2, -gp2, -gt2m1}}, Vector<3>{{-2, -gp2, -gt2m1}},
             Vector<3>{{gp2, gt2m1, 2}}, Vector<3>{{gp2, gt2m1, -2}}, Vector<3>{{gp2, -gt2m1, 2}}, Vector<3>{{-gp2, gt2m1, 2}},
             Vector<3>{{-gp2, -gt2m1, 2}}, Vector<3>{{-gp2, gt2m1, -2}}, Vector<3>{{gp2, -gt2m1, -2}}, Vector<3>{{-gp2, -gt2m1, -2}},

             Vector<3>{{g, 3, gt2}}, Vector<3>{{g, 3, -gt2}}, Vector<3>{{g, -3, gt2}}, Vector<3>{{-g, 3, gt2}},
             Vector<3>{{-g, -3, gt2}}, Vector<3>{{-g, 3, -gt2}}, Vector<3>{{g, -3, -gt2}}, Vector<3>{{-g, -3, -gt2}},
             Vector<3>{{3, gt2, g}}, Vector<3>{{3, gt2, -g}}, Vector<3>{{3, -gt2, g}}, Vector<3>{{-3, gt2, g}},
             Vector<3>{{-3, -gt2, g}}, Vector<3>{{-3, gt2, -g}}, Vector<3>{{3, -gt2, -g}}, Vector<3>{{-3, -gt2, -g}},
             Vector<3>{{gt2, g, 3}}, Vector<3>{{gt2, g, -3}}, Vector<3>{{gt2, -g, 3}}, Vector<3>{{-gt2, g, 3}},
             Vector<3>{{-gt2, -g, 3}}, Vector<3>{{-gt2, g, -3}}, Vector<3>{{gt2, -g, -3}}, Vector<3>{{-gt2, -g, -3}}};
