...
void TruncatedOctahedron::calculateStatic(const std::string &attr) {
    RegularSolid<TruncatedOctahedron>::orientedVertices =
            {Vector<3>{{0, 1, 2}}, Vector<3>{{0, 1, -2}}, Vector<3>{{0, -1, 2}}, Vector<3>{{0, -1, -2}},
             Vector<3>{{0, 2, 1}}, Vector<3>{{0, 2, -1}}, Vector<3>{{0, -2, 1}}, Vector<3>{{0, -2, -1}},

             Vector<3>{{1, 2, 0}}, Vector<3>{{1, -2, 0}}, Vector<3>{{-1, 2, 0}}, Vector<3>{{-1, -2, 0}},
             Vector<3>{{2, 1, 0}}, Vector<3>{{2, -1, 0}}, Vector<3>{{-2, 1, 0}}, Vector<3>{{-2, -1, 0}},

             Vector<3>{{2, 0, 1}}, Vector<3>{{2, 0, -1}}, Vector<3>{{-2, 0, 1}}, Vector<3>{{-2, 0, -1}},
             Vector<3>{{1, 0, 2}}, Vector<3>{{1, 0, -2}}, Vector<3>{{-1, 0, 2}}, Vector<3>{{-1, 0, -2}}};

    RegularSolid<TruncatedOctahedron>::orientedFaces =
